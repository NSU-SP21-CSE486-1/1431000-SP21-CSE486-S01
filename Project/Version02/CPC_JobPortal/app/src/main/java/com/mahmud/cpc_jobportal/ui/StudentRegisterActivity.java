...
public class StudentRegisterActivity extends AppCompatActivity {
    ...
    private void Registration() {
        name_reg = findViewById(R.id.name_register_student);
        id_reg = findViewById(R.id.id_register_student);
        email_reg = findViewById(R.id.email_register_student);
        password_reg = findViewById(R.id.password_register_student);

        btn_reg = findViewById(R.id.btn_register_student);
        ...
        btn_login = findViewById(R.id.btn_login_student);
